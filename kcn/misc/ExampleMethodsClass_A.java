...
public class ExampleMethodsClass_A
{
     ...
     */
    public void printSomething(@NotNull CallMe<Integer, Int2D> methodReference, int a, int b)
    {
        System.out.println("This is printSomething() from " +
                           this.getClass().getName() +
                           " instance \n\tX: " +
                           bib * methodReference.run(a, b).x() +
                           "\t Y: " +
                           bib * methodReference.run(a, b).y()); /**/
    }
